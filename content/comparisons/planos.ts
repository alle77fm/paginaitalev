...
export interface Plano {
  ...
  implantacao: number; implantacaoPrefixo?: string; implantacaoLabel: string; descricaoCurta: string;
  recursos: string[]; destaque: boolean; badgeTexto?: string; subTexto?: string; implantacaoGratisAnual: boolean;
  ctaTexto: string; mensagemWhatsapp: string;
}
export const planos: Plano[] = [
  { id: 'start', nome: 'Start', preco: 149, implantacao: 497, implantacaoLabel: 'Criação e ativação do app', descricaoCurta: 'Para pequenos negócios que querem começar a vender online com catálogo próprio e pedidos pelo WhatsApp.', recursos: ['Catálogo online próprio', 'Pedidos direto no WhatsApp da loja', 'Pagamento via PIX', 'Popup de vendas e promoções'], destaque: false, implantacaoGratisAnual: true, ctaTexto: 'Quero conhecer o Start', mensagemWhatsapp: 'Olá, quero conhecer o plano Start da Italev Sistemas.' },
  { id: 'pro', nome: 'Pro', preco: 219, implantacao: 897, implantacaoLabel: 'Criação e ativação do app', descricaoCurta: 'Para comércios que querem vender com mais organização, divulgar ofertas e profissionalizar o atendimento pelo WhatsApp.', recursos: ['Tudo do plano Start', 'Marca e domínio próprios', 'Relatórios e dashboard de vendas', 'Disparo de promoções', 'Agendamento de entrega', 'Cupons de desconto', 'Tabloide de ofertas em PDF'], destaque: true, badgeTexto: 'Mais recomendado', subTexto: 'Menos de R$7 por dia', implantacaoGratisAnual: true, ctaTexto: 'Quero conhecer o Pro', mensagemWhatsapp: 'Olá, quero conhecer o plano Pro da Italev Sistemas.' },
  { id: 'master', nome: 'Master', preco: 697, precoPrefixo: 'A partir de', implantacao: 1497, implantacaoPrefixo: 'A partir de', implantacaoLabel: 'Criação e ativação personalizada', descricaoCurta: 'Para negócios com operação mais estruturada, maior volume de produtos ou necessidade de acompanhamento mais próximo.', recursos: ['Tudo do plano Pro', 'Suporte prioritário', 'Implantação mais assistida', 'Configuração avançada do catálogo', 'Orientação inicial mais próxima', 'Melhor acompanhamento nos primeiros dias'], destaque: false, implantacaoGratisAnual: true, ctaTexto: 'Falar sobre o Master', mensagemWhatsapp: 'Olá, quero falar sobre o plano Master da Italev Sistemas.' },
];
