            ...
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-8 lg:gap-14">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <a
                  ...
                  className="absolute bottom-3 left-1/2 z-20 inline-flex min-h-[72px] w-[min(92%,390px)] -translate-x-1/2 items-center justify-center gap-4 rounded-2xl border border-white/15 bg-[#07080A]/68 px-5 py-4 text-sm font-bold text-white shadow-[0_22px_56px_rgba(0,0,0,0.42)] backdrop-blur-xl transition-all hover:-translate-y-0.5 hover:border-primary-container/45 hover:bg-[#07080A]/82 active:translate-y-0 md:bottom-4 md:w-[430px] md:-translate-x-[calc(50%+2rem)] lg:w-[460px] lg:-translate-x-[calc(50%+2.5rem)]"
                >
