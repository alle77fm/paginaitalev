            ...
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-8 lg:gap-14">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <a
                  ...
                  className="absolute bottom-4 left-1/2 z-20 inline-flex min-h-[48px] w-auto -translate-x-1/2 items-center justify-center gap-2.5 rounded-xl border border-white/10 bg-[#07080A]/72 px-4 py-2.5 text-xs font-bold text-white shadow-[0_14px_34px_rgba(0,0,0,0.34)] backdrop-blur-xl transition-all hover:-translate-y-0.5 hover:border-primary-container/40 hover:bg-[#07080A]/88 active:translate-y-0 sm:text-sm md:bottom-7 md:-translate-x-[calc(50%+2rem)] md:px-5 lg:-translate-x-[calc(50%+2.5rem)]"
                >
