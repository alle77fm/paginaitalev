    ...
    <>
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              ...
              className="text-[#94A3B8] hover:text-[#FF5A00] transition-colors"
            >
            ...
            <Link
              href="/planos"
              className="bg-[#FF5A00] hover:bg-[#e04e00] text-white px-5 py-2 rounded-[10px] text-sm font-semibold transition-all duration-200 shadow-[0_0_20px_rgba(255,90,0,0.35)]"
            >
              Ver Planos
            </Link>
          </div>
      ...
      {mobileOpen && (
        ...
        >
          ...
          <Link
            href="/planos"
            className="mt-4 bg-[#FF5A00] hover:bg-[#e04e00] text-white px-8 py-3 rounded-[10px] text-base font-semibold transition-all"
            onClick={() => setMobileOpen(false)}
          >
            Ver Planos
          </Link>
